        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              <div className="flex flex-col md:flex-row gap-8 mb-8">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xl text-gray-600 mb-6">감독: {movie.director}</p>
                  ...
                  {/* 줄거리 */}
                  <div className="mb-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-3">줄거리</h3>
                  ...
                  {cast.map((actor) => (
                    <div key={actor.id} className="flex items-center gap-3">
                      ...
                      <div className="min-w-0 flex-1">
                        <h4 className="font-semibold text-gray-900 text-sm truncate">{actor.name}</h4>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900">OST</h2>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {trailers.map((trailer) => (
                  <div key={trailer.id} className="group cursor-pointer">
                    ...
                    <h4 className="font-medium text-gray-900 text-sm">{trailer.title}</h4>
                  </div>
                ))}
              </div>
            </div>
            ...
            {/* 비슷한 키워드 영화 추천 */}
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">비슷한 키워드 영화</h2>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <h3 className="font-bold text-lg text-gray-900 mb-6">관련 기사</h3>
              <div className="space-y-6">
                {relatedArticles.map((article) => (
                  <div key={article.id} className="group cursor-pointer">
                    ...
                    <h4 className="font-medium text-gray-900 text-sm mb-2 line-clamp-2 group-hover:text-blue-600 transition-colors">
                      {article.title}
                    </h4>
