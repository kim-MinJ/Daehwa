    ...
    public class MovieInfoSave {
        ...
        private static final Map<String, String[]> genreToFeelingMap = Map.ofEntries(
            entry("Action", new String[] { "화남", "긴장됨", "놀람", "짜릿함", "흥분됨" }),
            entry("Adventure", new String[] { "심심함", "설렘", "긴장됨", "흥분됨", "즐거움" }),
            entry("Animation", new String[] { "기쁨", "편안함", "즐거움", "설렘", "심심함" }),
            entry("Comedy", new String[] { "기쁨", "편안함", "심심함", "즐거움", "설렘" }),
            entry("Crime", new String[] { "화남", "긴장됨", "심심함", "놀람", "짜릿함" }),
            entry("Documentary", new String[] { "슬픔", "피곤함", "감동적임", "편안함", "생각남" }),
            entry("Drama", new String[] { "슬픔", "기쁨", "편안함", "감동적임", "설렘" }),
            entry("Family", new String[] { "기쁨", "편안함", "감동적임", "즐거움", "설렘" }),
            entry("Fantasy", new String[] { "슬픔", "편안함", "흥분됨", "설렘", "놀람" }),
            entry("History", new String[] { "피곤함", "감동적임", "슬픔", "생각남", "설렘" }),
            entry("Horror", new String[] { "긴장됨", "놀람", "짜릿함", "화남", "심심함" }),
            entry("Music", new String[] { "기쁨", "설렘", "편안함", "즐거움", "감동적임" }),
            entry("Mystery", new String[] { "긴장됨", "놀람", "심심함", "짜릿함", "화남" }),
            entry("Romance", new String[] { "기쁨", "설렘", "슬픔", "편안함", "감동적임" }),
            entry("Science Fiction", new String[] { "심심함", "흥분됨", "놀람", "설렘", "짜릿함" }),
            entry("TV Movie", new String[] { "편안함", "심심함", "즐거움", "설렘", "감동적임" }),
            entry("Thriller", new String[] { "긴장됨", "놀람", "화남", "짜릿함", "심심함" }),
            entry("War", new String[] { "화남", "긴장됨", "짜릿함", "슬픔", "감동적임" }),
            entry("Western", new String[] { "흥분됨", "짜릿함", "화남", "놀람", "심심함" })
);
