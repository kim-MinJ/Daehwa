...
// "AIzaSyD1rmIqvjUmHJ7mh1hvYPpOsFe0DxN1vUg";
...
// @Bean
// public Job saveSoundTrackJob(JobRepository jobRepository,
...
// @Bean
// public Step saveSoundTrackStep(JobRepository jobRepository,
// PlatformTransactionManager transactionManager) {
...
// @Bean
// public ItemProcessor<MovieInfoEntity, List<SoundTrackEntity>>
// movieProcessor() {
// return movie -> {
...
// // YouTube 검색 + 재시도 적용
// List<YouTubeResult> results = searchYouTubeMultipleWithRetry(movie.getTitle()
// + " OST", 3);
...
// */
// private List<YouTubeResult> searchYouTubeMultipleWithRetry(String query, int
// maxResults) {
// int attempts = 0;
// int maxAttempts = 3;
...
// } catch (Exception e) {
// attempts++;
// System.out.println("YouTube 검색 오류: " + query + " / 시도 " + attempts + " / " +
// e.getMessage());
// try {
